              ...
              <Link as={`/applications/${application.slug}`} href="/applications/[slug]">
                <a>
                  <div class="uk-card uk-card-default uk-card-hover uk-height-1-1">
                    <div class="uk-cover-container uk-height-small uk-card-media-top">
                      {
                        application.thumbnail && (
                          <img src={application.thumbnail.responsiveImage.src} alt="" uk-cover={true} />
                        )
                      }
                    </div>
                    <div class="uk-card-body uk-card-body-small">
