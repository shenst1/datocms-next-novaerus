...
- `NEXT_PUBLIC_PREVIEW_SECRET` can be any random string (but avoid spaces), like `MY_SECRET` - this is used for [the Preview Mode](/docs/advanced-features/preview-mode.md).
...
- `<secret>` should be the string you entered for `NEXT_PUBLIC_PREVIEW_SECRET`.
